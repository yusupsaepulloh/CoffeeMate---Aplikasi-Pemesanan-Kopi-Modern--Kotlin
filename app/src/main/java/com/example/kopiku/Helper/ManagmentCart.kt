...
import com.example.kopiku.Helper.TinyDB
...
class ManagmentCart(val context: Context) {
    ...
    fun insertItems(item: ItemsModel) {
        ...
        Toast.makeText(context, "${item.title} Add to Cart", Toast.LENGTH_SHORT).show()
    }
    ...
    fun romoveItem(listItems: ArrayList<ItemsModel>, position: Int, listener: ChangeNumberItemsListener) {
